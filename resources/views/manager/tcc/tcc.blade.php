...
<div class="d-flex flex-wrap bg-gray-400 box-shadow rounded-2 px-4 py-3">
    ...
    <div class="col-12 d-flex flex-wrap align-items-end">
        <div class="col-12 col-sm-6 col-md-4 col-lg-4 my-3 px-2">
            ...
            <a class="btn btn-warning text-white" target="_blank"
                href="{{ route('file', substr($tcc->file_pretcc, 4)) }}">VISUALIZAR</a>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-4 my-3 px-2">
            <label class="form-label w-100">Termo de Compromisso de Orientação</label>
            <a class="btn btn-warning text-white" target="_blank"
                href="{{ route('file', substr($tcc->term_commitment, 4)) }}">VISUALIZAR</a>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-2 d-flex flex-column my-3 px-2">
            ...
            <div class="btn-group btn-group-toggle" data-toggle="buttons">
                <label class="btn btn-secondary">
                    <input class="form-check-input" name="ethics_committee" type="radio" @if ($tcc->ethics_committee)
                    checked @endif disabled> sim
                </label>
                <label class="btn btn-secondary">
                    <input class="form-check-input" name="ethics_committee" type="radio" @if (!$tcc->ethics_committee)
                    checked @endif disabled> não
                </label>
            </div>
        </div>
