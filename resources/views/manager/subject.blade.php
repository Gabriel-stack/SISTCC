        ...
        <div class="row mx-0 align-items-center">
            <form class="col d-flex align-items-center" action="{{ route('manager.student.search') }}" method="GET">
                ...
                <div class="col-2">
                    ...
                    <select name="status" id="status_search" class="form-select w-auto">
                ...
                <div class="col-2">
                    ...
                    <select name="stage" id="stage_search" class="form-select w-auto">
                        <option>Selecione</option>
                ...
                <div class="col-4">
                    ...
                    <select name="professor" id="professor_search" class="form-select w-auto">
                        <option>Selecione</option>
