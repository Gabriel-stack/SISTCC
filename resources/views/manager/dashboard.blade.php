...
<div class="my-5 py-4 row bg-white rounded-2 box-shadow justify-content-between align-items-center">
    <form class="row mx-0 align-items-center col-12" role="search"
        action="{{ route('manager.student.search') }}" method="GET">
        ...
        <div class="col-3">
            ...
            <select name="professor" id="professor_search" class="form-select">
                <option >Selecione</option>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="d-flex gap-1">
                    ...
                    <a class="btn btn-info" href="{{route('manager.student.show', ['student' => $student])}}">
                        <i class="bi bi-eye"></i>
                    </a>
                </td>
            </tr>
