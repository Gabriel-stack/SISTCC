...
@section('container')
    ...
    <form action="{{ route('student.progress.requirement.store', $tcc->subject_id) }}" method="POST"
        ...
        <div class="d-flex flex-wrap align-items-baseline bg-gray-400 box-shadow rounded-2 p-3 mb-3">
            <div class="col-12 col-md-6 col-lg-3">
                ...
                <div class="my-2 px-2">
                    ...
                    <input type="datetime-local" class="form-control" name="intended_date" id="intended_date" value="{{ date('Y-m-d\TH:i', strtotime($tcc->intended_date)) ?? '' }}">
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-3">
                <div class="my-2 px-2">
                ...
                <div class="my-2 px-2">
                    ...
                    <input type="text" class="form-control" name="keywords" id="keywords" value="{{ $tcc->keywords ?? '' }}">
                </div>
            </div>
        ...
        <div class="d-flex flex-wrap justify-content-center align-items-center bg-gray-400 box-shadow rounded-2 p-3 my-3 px-2">
        ...
        <div class="d-flex flex-wrap align-items-baseline bg-gray-400 box-shadow rounded-2 p-3 my-3 px-2">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 my-2 px-2">
                ...
                <input type="text" class="form-control" name="members[one][name]" id="name" value="{{ json_decode($tcc->members)->one->name ?? '' }}">
            </div>
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 my-2 px-2">
                <label for="members[one][cpf]" class="form-label">CPF</label>
                <input type="text" class="form-control" name="members[one][cpf]" id="cpf" value="{{ json_decode($tcc->members)->one->cpf ?? '' }}">
            </div>
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 my-2 px-2">
                <label for="members[one][titration]" class="form-label">Titulação</label>
                <input type="text" class="form-control" name="members[one][titration]" id="members[one][titration]" value="{{ json_decode($tcc->members)->one->titration ?? '' }}">
            </div>
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 my-2 px-2">
                <label for="members[one][organ]" class="form-label">Orgão</label>
                <input type="text" class="form-control" name="members[one][organ]" id="members[one][organ]" value="{{ json_decode($tcc->members)->one->organ ?? '' }}">
            </div>
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 my-2 px-2">
        ...
        <div class="d-flex flex-wrap align-items-baseline bg-gray-400 box-shadow rounded-2 p-3 my-3 px-2">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 my-2 px-2">
                ...
                <input type="text" class="form-control" name="members[two][name]" id="members[two][name]" value="{{ json_decode($tcc->members)->two->name ?? '' }}">
            </div>
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 my-2 px-2">
                <label for="members[two][cpf]" class="form-label">CPF</label>
                <input type="text" class="form-control" name="members[two][cpf]" id="cpf" value="{{ json_decode($tcc->members)->two->cpf ?? '' }}">
            </div>
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 my-2 px-2">
                <label for="members[two][titration]" class="form-label">Titulação</label>
                <input type="text" class="form-control" name="members[two][titration]" id="members[two][titration]" value="{{ json_decode($tcc->members)->two->titration ?? '' }}">
            </div>
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 my-2 px-2">
                <label for="members[two][organ]" class="form-label">Orgão</label>
                <input type="text" class="form-control" name="members[two][organ]" id="members[two][organ]" value="{{ json_decode($tcc->members)->two->organ ?? '' }}">
            </div>
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 my-2 px-2">
        ...
        <div class="d-flex flex-wrap align-items-baseline bg-gray-400 box-shadow rounded-2 p-3 my-3 px-2">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 my-2 px-2">
                ...
                <input type="text" class="form-control" name="members[three][name]" id="members[three][name]" value="{{ json_decode($tcc->members)->three->name ?? '' }}">
            </div>
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 my-2 px-2">
                <label for="members[three][cpf]" class="form-label">CPF</label>
                <input type="text" class="form-control" name="members[three][cpf]" id="cpf" value="{{ json_decode($tcc->members)->three->cpf ?? '' }}">
            </div>
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 my-2 px-2">
                <label for="members[three][titration]" class="form-label">Titulação</label>
                <input type="text" class="form-control" name="members[three][titration]" id="members[three][titration]" value="{{ json_decode($tcc->members)->three->titration ?? '' }}">
            </div>
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 my-2 px-2">
                <label for="members[three][organ]" class="form-label">Orgão</label>
                <input type="text" class="form-control" name="members[three][organ]" id="members[three][organ]" value="{{ json_decode($tcc->members)->three->organ ?? '' }}">
            </div>
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 my-2 px-2">
